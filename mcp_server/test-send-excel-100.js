...
async function testSendExcelEmail100() {
    const tool = new SendExcelEmailTool();

    try {
        console.log('=== Testing SendExcelEmailTool with 100 records ===');
        ...
        console.log('Starting tool execution with 100 records...');
        ...
        console.error('Error testing SendExcelEmailTool with 100 records:', error);
        console.error('Error stack:', error.stack);
    }
}

testSendExcelEmail100();
